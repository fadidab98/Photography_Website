...
const Carousel =() => {
    ...
    const handleSlideClick = (index) => {
      ...
      swiperRef.current.slideTo(index); // Use the slideTo method to navigate
  ...
  return (
    ...
    >
     {images.map((image, index) =>{
        ...
        <SwiperSlide
         key={index}
        className={` ${getSlideSize(index)} mx-auto p-0 drop-shadow-none shadow-none z-0 relative cursor-pointer `} 
